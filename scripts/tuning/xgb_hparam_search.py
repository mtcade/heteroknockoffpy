#
#//  scripts/tuning/xgb_hparam_search.py
#//  heteroknockoffpy
#//
#//  One-off Optuna search for XGBRegressor hyperparameters, tuned against the
#//  oracle E[y|X] from get_ar1_simple_case. See docs/heteroknockoffpy/xgbImportance.html
...
def main():
    ...
    print("  oracle_expr: {}".format(case.function_str))
    ...
    out_path = "scripts/tuning/xgb_hparam_search_results.json"
