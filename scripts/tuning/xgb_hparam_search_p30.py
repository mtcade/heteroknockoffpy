#
#//  scripts/tuning/xgb_hparam_search_p30.py
#//  heteroknockoffpy
#//
#//  Re-tune of xgb_hparam_search_wide.py sized for synth_sweep_2's data shape:
#//  p_numeric=20, p_categorical=10 (p=30, vs. p=90 in the wide search),
#//  p_relevant=0.2 (gives exactly 4 relevant numeric + 2 relevant categorical,
#//  matching synth_sweep_2's fixed fn_str), rho=0.67 (synth_sweep_2's baseline,
#//  vs. 0.5 in prior searches). Same search objective/space/procedure as the
#//  original -- only DATA_PARAMS differs. See
#//  docs/heteroknockoffpy/xgbImportance.html for the design rationale.
#//
...
def main():
    ...
    out_path = "scripts/tuning/xgb_hparam_search_p30_results.json"
