...
#//  heteroknockoffpy
#//
#//  Tests for heteroknockoffpy.utilities: one-hot encoding (get_ohe_df, get_ohe_np,
#//  get_oheDict) of pl.Categorical columns, always dropping the first lexical
#//  (sorted) category, plus makeChoices_ohe / collapse_ohe consistency when
#//  Xk is missing some of X's categories.
#
