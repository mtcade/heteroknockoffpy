#
#//  tests/test_ranger_mald.py
#//  heteroknockoffpy
#//
#//  Tests for rangerMaldImportances / stat_forest_mald_*.
#//
#//  3 × 3 grid: predictor type (numeric, categorical, mixed) ×
#//              outcome type (continuous, count, categorical).
#//
#//  Each test uses a strong signal so the signal variable's MALD importance
...
def test_ranger_mald_numeric_continuous():
    ...
    imp = importance.rangerMaldImportances(X=X, Xk=Xk, y=y)
    W   = _W(imp)
...
def test_ranger_mald_numeric_count():
    ...
    imp = importance.rangerMaldImportances(X=X, Xk=Xk, y=y, outcome_type='count')
    W   = _W(imp)
...
def test_ranger_mald_numeric_categorical():
...
def test_ranger_mald_categorical_continuous():
...
def test_ranger_mald_categorical_count():
...
def test_ranger_mald_categorical_categorical():
...
def test_ranger_mald_mixed_continuous():
...
def test_ranger_mald_mixed_count():
...
def test_ranger_mald_mixed_categorical():
